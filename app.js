(function(){
  ...
  // API endpoint for availability (pass ?api=https://host:8080 in WebApp URL)
  ...
  let serverNow = null; // to align "past" check
  ...
  // Init date range: today .. +6 (7 days total)
  ...
  async function loadAvailability(){
    if (!API_BASE) {
      renderTimeGrid([]);
      setNote("Подсказка: добавьте ?api=https://host:8080 в URL WebApp для отметки занятых слотов.");
      return;
    }
    try{
